...
function addads(){
	...
	html +='<a target="_blank" href="https://chrome.google.com/webstore/detail/eekjldapjblgadclklmgolijbagmdnfk"><strong>SearchO</strong> The easiest way to access different search engines. ?</a>'
	html +='</div></div>';
